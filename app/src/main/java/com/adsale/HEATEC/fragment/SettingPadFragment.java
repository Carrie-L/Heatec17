...
public class SettingPadFragment extends BaseFragment{
	...
	private void addToCalendar(){
		...
		if(hasCalPermission){
			DialogUtils.showAlertDialog(mContext, R.string.ask_addToCalendar, R.string.ok, R.string.cancel, new DialogInterface.OnClickListener() {
				@Override
...
//			PermissionUtil.requestPermission(getActivity(),PermissionUtil.PERMISSION_READ_CALENDAR,PermissionUtil.PMS_CODE_READ_CALENDAR);
	...
	private void resetAll(){
		// <item>閲嶇疆鎵�湁瑷�?/item>
		DialogUtils.showAlertDialog(mContext, R.string.ask_clear, R.string.yes, R.string.no, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
