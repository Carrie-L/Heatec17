    ...
    private OnClickListener savaNoteListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.btnSave) {
                ...
                DialogUtil.showConfirmAlertDialog(mContext, mContext.getString(R.string.note_successful));
            } else {
                DialogUtil.showAlertDialog(mContext, R.string.ask_clear_note, new DialogInterface.OnClickListener() {
                    @Override
